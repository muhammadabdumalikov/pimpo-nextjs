...
export const metadata: Metadata = {
  title: "Next.js Avatars | Pimpo - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Pimpo - Next.js Tailwind CSS Admin Dashboard Template",
};

export default function AvatarPage() {
  return (
    <div>
      <PageBreadcrumb pageTitle="Avatar" titleKey="sidebar.avatar" />
