...
export const metadata: Metadata = {
  title: "Next.js Buttons | Pimpo - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for Pimpo - Next.js Tailwind CSS Admin Dashboard Template",
};

export default function Buttons() {
  return (
    <div>
      <PageBreadcrumb pageTitle="Buttons" titleKey="sidebar.buttons" />
